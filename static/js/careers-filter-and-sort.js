    ...
    if (domList) {
      ...
      show20MoreEl.addEventListener("click", (e) => {
        ...
        if (domList.childElementCount < window.careersJobList.childElementCount) {
          let currentListRolesNodesCount = domList.childElementCount;
          // Offset = limit + 1
          const offsetListRolesNodesCount = currentListRolesNodesCount + 21;
          ...
          show20MoreEl.classList.add("u-hide")
        }
